...
/**
 * Servlet implementation class SetScurityQuestion
 */
@WebServlet("/SetScurityQuestion")
public class SetScurityQuestion extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SetScurityQuestion() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			BeanLoginInfo list=DataManager.receiveData(connection, username);
