...
/**
 * Servlet implementation class Table2stupage
 */
@WebServlet("/Table2stupage")
public class Table2stupage extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Table2stupage() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			ArrayList<BeanTable> list=DataManager.receivetable2(connection,rollno);
			int count=0;
			if(list.size()>count)
			{	
				JsonObject json = new JsonObject();
					...
					json.addProperty("message", "No attendance list found for this rollno");
					response.getWriter().write(json.toString());
				}
		} catch (Exception e) {
